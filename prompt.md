...
### Jira Ticket: KAN-31
**Summary:** Implement GraphQL query to fetch appointment details by ID
**Status:** In Progress
**Priority:** Medium
**Labels:** none
**URL:** https://hpe-team2.atlassian.net/browse/KAN-31

**Description:**
Implement a GraphQL query for the appointment service that fetches a single appointment by ID. The query should return the appointment's id, patientName, doctorName, date, and status fields. This is a GraphQL query operation and should be added to the existing appointment schema and resolver layer. Acceptance Criteria: GraphQL query named getAppointment accepts an id argument Returns appointment details for the given ID Returns appropriate error if appointment not found Schema updated in appointment-service.graphql Supergraph recompiled via compose.py
